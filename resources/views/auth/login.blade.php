...
<head>
    ...
    <style>
        body {
            ...
            background-color: #F0FDF4; /* a very light pastel green */
        }
    </style>
</head>
<body>
...
<div class="flex min-h-screen items-center justify-center p-4">
    ...
    <div class="flex w-full max-w-5xl overflow-hidden rounded-2xl shadow-2xl bg-white">
        ...
        <div class="hidden lg:flex w-1/2 flex-col items-center justify-center p-12 bg-green-100 text-center relative">
            {{-- Decorative shapes --}}
            <div class="absolute top-0 left-0 w-32 h-32 bg-green-200 rounded-full -translate-x-1/2 -translate-y-1/2"></div>
            <div class="absolute bottom-0 right-0 w-48 h-48 bg-green-200 rounded-lg translate-x-1/4 translate-y-1/4 rotate-45"></div>
            
            <div class="z-10">
                <img src="https://placehold.co/120x120/FFFFFF/16A34A?text=LOGO" alt="Logo SMPN 3 Mojosongo" class="mx-auto mb-6 rounded-full">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12">
            <div class="w-full max-w-md">
                ...
                @if ($errors->any())
                    <div class="bg-red-50 border border-red-200 text-red-700 px-4 py-3 mb-6 rounded-lg relative" role="alert">
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-6">
                    @csrf
                    <div>
                        <label for="email" class="block text-sm font-medium text-gray-700 sr-only">Alamat Email</label>
