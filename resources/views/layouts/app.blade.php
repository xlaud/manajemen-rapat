...
<head>
    ...
    <style>
        /* Tetapkan font default di sini jika tidak melalui tailwind.config.js */
        body {
        ...
        <div class="container mx-auto mt-4">
            <div class="flex flex-wrap gap-2">
                ...
                @if(Auth::user()->role === 'admin')
                    <a href="{{ route('teachers.index') }}" class="flex items-center space-x-2 px-3 py-2 rounded-lg transition duration-300 ease-in-out text-sm {{ request()->routeIs('teachers.*') ? 'bg-blue-900 text-white shadow-md' : 'text-blue-100 hover:bg-blue-700 hover:text-white' }}">
                ...
                @elseif(Auth::user()->role === 'guru')
                    ...
                    <a href="{{ route('presensi.create') }}" class="flex items-center space-x-2 px-3 py-2 rounded-lg transition duration-300 ease-in-out text-sm {{ request()->routeIs('presensi.create') ? 'bg-blue-900 text-white shadow-md' : 'text-blue-100 hover:bg-blue-700 hover:text-white' }}">
